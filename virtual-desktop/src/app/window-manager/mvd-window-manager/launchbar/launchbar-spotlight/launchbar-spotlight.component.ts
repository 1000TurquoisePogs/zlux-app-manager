...
@Component({
  selector: 'rs-com-launchbar-spotlight',
  templateUrl: './launchbar-spotlight.component.html',
  styleUrls: ['./launchbar-spotlight.component.css']
})
export class LaunchbarSpotlightComponent {
